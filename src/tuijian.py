...
book = xlrd.open_workbook('critics.xlsx')
sheet = book.sheet_by_index(0)
nrows = sheet.nrows

#生成字典
dic = {sheet.cell_value(i,0): '' for i in range(nrows)}

for i in range(0,nrows):
	cell3 = sheet.cell_value(i,0)
	cell5 = sheet.cell_value(i,1)
	list1 = list(dic.get(cell3))
	list1.append(cell5)
	dic[cell3] = tuple(list1)
...
if __name__=='__main__':
	W3=Usersim(dic)
	Last_Rank=Recommend('Toby',dic,W3,2)
	print(Last_Rank)
